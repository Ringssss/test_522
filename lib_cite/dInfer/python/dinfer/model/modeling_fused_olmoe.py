...
def torch_all_reduce(tensor):
    ...
    return tensor
# Do NOT patch unconditionally — in DP mode (tp=1, dp>1) this would
# all_reduce on the world group instead of the TP group, causing 4x output.
# Conditional patching is handled by _maybe_patch_all_reduce() at runtime.
